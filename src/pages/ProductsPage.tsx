...
const ProductsPage = () => {
  useEffect(() => {
    ...
    document.title = "Products | Z-ON DOOR";
          ...
          <div className="container mx-auto px-4">
            <AnimateInView animation="fade-in">
              <div className="bg-white rounded-lg shadow p-8 text-center max-w-4xl mx-auto">
                <h2 className="text-2xl font-bold mb-4">Looking for Custom Designs?</h2>
                <p className="mb-6 text-gray-600">
                  We can create custom door designs based on your specific requirements.
                  Contact us today to discuss your project needs.
                </p>
                <a 
                  href="https://wa.me/919876543210?text=Hello,%20I'd%20like%20to%20enquire%20about%20custom%20door%20designs."
                  target="_blank"
